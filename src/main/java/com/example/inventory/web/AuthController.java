...
import com.example.inventory.web.dto.AuthRequest.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody AuthRequest req) {
        ...
        AuthResponse resp = AuthResponse.builder().token(token).username(u.getUsername()).roles(u.getRoles()).build();
